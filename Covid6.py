...
if provincia_seleccionada != "Seleccione una opción":
    ...
    if distrito_seleccionado != "Seleccione una opción":
        ...
        # Mostrar los datos filtrados para depurar
        st.write("Datos de df3 después de aplicar filtros:")
        st.write(df3[(df3['region'] == region_seleccionada) & 
                      (df3['provincia'] == provincia_seleccionada) & 
                      (df3['distrito'] == distrito_seleccionado)])
